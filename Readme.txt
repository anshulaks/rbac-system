...
1. Unzip the provided project folder (rbac-system.zip) into a directory of your choice.
...
1. The project includes a .env file for environment variables. No additional setup is required.
